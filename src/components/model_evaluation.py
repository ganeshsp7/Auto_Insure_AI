...
from src.entity.s3_estimator import vehicle_estimator
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[vehicle_estimator]:
        """
        ...
        try:
            ...
            proj1_estimator = vehicle_estimator(bucket_name=bucket_name,
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            metric_file_path = self.model_trainer_artifact.metric_artifact_file_path

            # Load the metrics from JSON file
            with open(metric_file_path, "r") as f:
                metric_report = json.load(f)

            # Now access the f1_score
            trained_model_f1_score = metric_report["f1_score"]
