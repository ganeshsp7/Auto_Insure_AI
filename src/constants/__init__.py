...
if not DATABASE_NAME or not COLLECTION_NAME or not MONGODB_URL_KEY:
    raise ValueError("Critical environment variables for MongoDB are missing!")
...
MODEL_TRAINER_METRIC_REPORT_FILE_NAME: str = "metric.yaml"
