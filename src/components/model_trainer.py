...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            # Create a dictionary to represent the metrics
            metric_report = {
            ...
            with open(self.model_trainer_config.model_trainer_metric_report_file_path, "w") as metric_report_file:
                json.dump(metric_report , metric_report_file, indent=4)

            model_trainer_artifact = ModelTrainerArtifact(
                trained_model_file_path=self.model_trainer_config.trained_model_file_path,
                metric_artifact_file_path=self.model_trainer_config.model_trainer_metric_report_file_path,
            )
